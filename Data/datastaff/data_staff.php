...
$query = "SELECT * FROM data_staff ORDER BY id_staff DESC";
            ...
            <div class="row">
                <div class="col-md-12">
					...
					<table class="table table-stripped table-hover datatab">
						<thead>
							<tr><th>ID Staff</th><th>Nama Staff</th><th>Jenis Kelamin</th><th>Bidang Staff</th><th>Hari Kerja</th>
						...
						<tbody>
							...
							<td><?php echo $row["bidang_staff"]; ?></td>
							<td><?php echo $row["hari_kerja"]; ?></td>
							
							<?php if ($_SESSION['user_level'] == "Administrasi"){ ?><td>
							<!-- Button untuk modal -->
							<a href="#" type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#myModal<?php echo $row['id_staff']; ?>">Edit</a></td>
							<td><a href="#" class="btn btn-danger btn-flat btn-xs" data-toggle="modal" data-target="#deleteuser<?php echo $row['id_staff']; ?>"><i class="fa fa-trash"></i> Delete</a>
							</td><?php } ?>
							</tr>
						
					
					<!-- Modal Edit Mahasiswa-->
					<div class="modal fade" id="myModal<?php echo $row['id_staff']; ?>" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<?php
									$id = $row['id_staff']; 
									$query_edit = mysqli_query($connect,"SELECT * FROM data_staff WHERE id_staff='$id'");
								...
								?>
									...
									<input type="text" name="id" class="form-control" readonly value="<?php echo $data['id_staff']; ?>">      
									</div>
									
									<div class="form-group">
									<label>Name</label>
									<input type="text" name="nama" class="form-control" value="<?php echo $data['nama_staff']; ?>">      
									</div>
									
									<div class="form-group">
									<label>Gender</label>
									<input type="text" name="gender" class="form-control" value="<?php echo $data['jenis_kelamin']; ?>"> 
									</div>
									
									<div class="form-group">
									<label>Specialties</label>
									<input type="text" name="spesial" class="form-control" value="<?php echo $data['bidang_staff']; ?>">      
									</div>
									
									<div class="form-group">
									<label>Working Days</label>
									<input type="text" name="hari" class="form-control" value="<?php echo $data['hari_kerja']; ?>">      
									</div>
					...
					<div class="example-modal">
                        <div id="deleteuser<?php echo $row['id_staff']; ?>" class="modal fade" role="dialog" style="display:none;">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <div class="modal-body">
                                <h4 align="center" >Sure to delete data of Doctor with id <?php echo $row['id_staff'];?><strong><span class="grt"></span></strong> ?</h4>
                              </div>
                              <div class="modal-footer">
                                <button id="nodelete" type="button" class="btn btn-danger pull-left" data-dismiss="modal">Cancel</button>
                                <a href="delete.php?act=deleteuser&id=<?php echo $row['id_staff']; ?>" class="btn btn-primary">Delete</a>
                              </div>
                            </div>
                          </div>
                        </div>
