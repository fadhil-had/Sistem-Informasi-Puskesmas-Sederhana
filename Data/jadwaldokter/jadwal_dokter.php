...
$query = "SELECT * FROM data_dokter ORDER BY hari_praktek DESC";
            ...
            <div class="row">
                <div class="col-md-12">
					...
					<table class="table table-stripped table-hover datatab">
						<thead>
							<tr><th>ID Dokter</th><th>Nama Dokter</th><th>Spesialis</th><th>Hari Praktek</th><th>Jam Masuk</th><th>Jam Keluar</th>
						...
						<tbody>
							...
							<td><?php echo $row["spesialisasi_dokter"]; ?></td>
							...
							<!-- Button untuk modal -->
							<a href="#" type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#myModal<?php echo $row['id_dokter']; ?>">Edit</a></td>
							<td><a href="#" class="btn btn-danger btn-flat btn-xs" data-toggle="modal" data-target="#deleteuser<?php echo $row['id_dokter']; ?>"><i class="fa fa-trash"></i> Delete</a>
							</td><?php } ?>
							</tr>
						
					
					<!-- Modal Edit Mahasiswa-->
					<div class="modal fade" id="myModal<?php echo $row['id_dokter']; ?>" role="dialog">
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<?php
									$id = $row['id_dokter']; 
									$query_edit = mysqli_query($connect,"SELECT * FROM data_dokter WHERE id_dokter='$id'");
								...
								?>
									...
									<input type="text" name="id" class="form-control" readonly value="<?php echo $data['id_dokter']; ?>">      
									</div>
									
									<div class="form-group">
									<label>Name</label>
									<input type="text" name="nama" class="form-control" value="<?php echo $data['nama_dokter']; ?>">      
									</div>
									
									<div class="form-group">
									<label>Specialties</label>
									<input type="text" name="spesial" class="form-control" value="<?php echo $data['spesialisasi_dokter']; ?>">      
									</div>
									
									<div class="form-group">
									<label>Working Days</label>
									<input type="text" name="hari" class="form-control" value="<?php echo $data['hari_praktek']; ?>"> 
									</div>
					...
					<div class="example-modal">
                        <div id="deleteuser<?php echo $row['id_dokter']; ?>" class="modal fade" role="dialog" style="display:none;">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <div class="modal-body">
                                <h4 align="center" >Sure to delete data of Doctor with id <?php echo $row['id_dokter'];?><strong><span class="grt"></span></strong> ?</h4>
                              </div>
                              <div class="modal-footer">
                                <button id="nodelete" type="button" class="btn btn-danger pull-left" data-dismiss="modal">Cancel</button>
                                <a href="delete.php?act=deleteuser&id=<?php echo $row['id_dokter']; ?>" class="btn btn-primary">Delete</a>
                              </div>
                            </div>
                          </div>
                        </div>
