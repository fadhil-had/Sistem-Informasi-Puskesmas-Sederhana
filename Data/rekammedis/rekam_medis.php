...
$query = "SELECT * FROM rekam_medis WHERE tanggal_kunjungan='$tgl' && id_pasien = '$id'";
} else {
$query = "SELECT * FROM rekam_medis WHERE tanggal_kunjungan='$tgl' ORDER BY tanggal_kunjungan DESC";}
            ...
            <div class="row">
                <div class="col-md-12">
					...
					<table class="table table-stripped table-hover datatab">
						<thead>
							<tr><th>ID Pasien</th><th>Nama Pasien</th><th>Diagnosa</th><th>Tindakan</th><th>Resep Obat</th>
						...
						<tbody>
							...
							<!-- Button untuk modal -->
							<a href="#" type="button" class="btn btn-success btn-md" data-toggle="modal" data-target="#myModal<?php echo $row['id_pasien']; ?>">Input Obat</a></td>
							</td><?php } ?>
							</tr>
